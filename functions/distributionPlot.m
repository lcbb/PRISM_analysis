        ...
        switch floor(opt.histOpt)
            ...
            case 1
                ...
                if opt.histOpt == 1.1
                    ...
                    [dummy,x] = histogramOld(currentData); %#ok<ASGLU>
                    if length(x) == 1
            ...
            case 2
                ...
                [xHist,yHist] = histogramOld(currentData,opt.divFactor,0);
            case 99
...
if opt.showMM
    ...
    switch opt.xyOri
        case 'normal'
            ...
            if opt.showMM == 4
                mh = plot(ah,opt.xValues+xOffset,m,'+k','Color','k','MarkerSize',12, 'lineWidth',1);
